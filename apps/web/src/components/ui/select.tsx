  ...
  const defaultProps = {
    children: (
      <>
        ...
        <CaretUpDown weight="thin" className={selectTriggerIconClassName} />
      </>
    ),
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          >
            <CaretUp weight="thin" className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollUpArrow>
          ...
          >
            <CaretDown weight="thin" className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
    </SelectPrimitive.Portal>
