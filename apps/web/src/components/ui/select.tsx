	...
	const defaultProps = {
		children: (
			<>
				...
				<CaretUpDownIcon weight="thin" className={selectTriggerIconClassName} />
			</>
		),
		...
		<SelectPrimitive.Portal>
			...
			>
				...
				>
					...
					>
						<CaretUpIcon weight="thin" className="relative size-4.5 sm:size-4" />
					</SelectPrimitive.ScrollUpArrow>
					...
					>
						<CaretDownIcon weight="thin" className="relative size-4.5 sm:size-4" />
					</SelectPrimitive.ScrollDownArrow>
				</SelectPrimitive.Popup>
			</SelectPrimitive.Positioner>
		</SelectPrimitive.Portal>
