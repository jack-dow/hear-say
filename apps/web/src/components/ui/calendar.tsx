...
export function Calendar({
	...
	const defaultClassNames = {
		...
		today:
			'*:after:pointer-events-none *:after:absolute *:after:bottom-1 *:after:inset-s-1/2 *:after:z-1 *:after:size-[3px] *:after:-translate-x-1/2 *:after:rounded-full *:after:bg-primary [&[data-selected]:not(.range-middle)>*]:after:bg-background [&[data-disabled]>*]:after:bg-foreground/30 *:after:transition-colors',
	...
	const defaultComponents = {
		Chevron: ({
			...
			return <CaretUpDownIcon weight="thin" className={chevronClassName} {...rest} aria-hidden="true" />
		},
	}
