  ...
  return (
    ...
    >
      {STEPS.map((step, index) => {
        ...
        const elapsedSeconds = isActive && startTime != null
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Connector line */}
              {!isLast && (
                <div className="relative my-0.5 h-6 w-px bg-muted-foreground/20">
                  <motion.div
            ...
            <div className={cn("pb-6", isLast && "pb-0")}>
              ...
              >
                ...
                {elapsedSeconds != null && elapsedSeconds >= 0 && (
                  <TextMorph
                    as="span"
                    className="ml-1.5 text-muted-foreground/60 font-normal"
                  >
